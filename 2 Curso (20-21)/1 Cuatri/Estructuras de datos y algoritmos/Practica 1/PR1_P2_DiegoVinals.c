...
tRango *asignarMemoriaR(int num){

    punteroRango = (tRango *) malloc(num *  sizeof(tRango));
   
}

tEmpleado *asignarMemoriaE(int num){

    punteroEmpleado = (tEmpleado *) malloc(num *  sizeof(tEmpleado));
}
...
int main(void){
    ...
    // finalizador 0, si es 1, se sale de programa
    finalizador = 0;
    while(finalizador == 0){
        opcion = menu();
        switch (opcion) {
            ...
            case OPCION_TRES:
                ...
                CalcularNuevosSueldos(punteroEmpleado, punteroRango );
