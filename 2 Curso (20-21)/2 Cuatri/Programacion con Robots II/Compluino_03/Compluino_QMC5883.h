...
#ifndef COMPLUINO_QMC5883_H
#define COMPLUINO_QMC5883_H
...
class COMPLUINO_QMC5883
{
public:
  COMPLUINO_QMC5883():isHMC_(false),isQMC_(false),minX(0),maxX(0),minY(0), maxY(0), minZ(0), maxZ(0),firstRun(true)
    {}
  bool begin(void);
